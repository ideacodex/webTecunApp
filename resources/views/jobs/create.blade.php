        ...
        <form method="POST" action="{{ url('jobsAdmin') }}" enctype="multipart/form-data"
            ...
            <div class="form-row">
                ...
                <div class="col-12 input-group input-group-lg mb-3">
                    ...
                    <input id="description" placeholder="Descripcion o texto corto" type="text"  class="text-primary form-control @error('description') is-invalid @enderror"
                ...
                <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                    ...
                    <input id="salary" name="salary" placeholder="Salario (opcional)" type="text" size="100" maxlength="100"
                        class="text-primary form-control @error('salary') is-invalid @enderror" salary="salary"
                        value="{{ old('salary') }}"   autofocus>
