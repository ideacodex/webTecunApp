            ...
            <div class="form-row">
                <div class="col-12 input-group input-group-lg mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text transparent" id="inputGroup-sizing-sm" title="Nombre completo">
                    ...
                    <input id="nombre" placeholder="Nombres" type="text" title="Nombre completo"
                        ...
                        value="{{ $contact->nombre }}" required autocomplete="nombre" autofocus>
                ...
                <div class="col-12 input-group input-group-lg mb-3">
                    ...
                    <input id="correo" placeholder="Correo del contacto" type="text" title="Correo del contacto"
                        ...
                        value="{{ $contact->correo }}" required autocomplete="correo" autofocus>
                ...
                <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                    ...
                    <input id="pais" placeholder="Pais del contacto" type="text" title="Pais"
                        ...
                        value="{{ $contact->pais }}" required autocomplete="pais" autofocus>
                ...
                <div class="col-12 col-md-6 input-group input-group-lg mb-3" title="Departamento laboral">
                    ...
                    <input id="departamento" placeholder="Departamento laboral" type="text" title="Departamento laboral"
                        ...
                        value="{{ $contact->departamento }}" required autocomplete="departamento" autofocus>
                ...
                <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                    ...
                    <input id="subDepartamento" placeholder="Sub Departamento" type="text" title="Sub Departamento"
                        ...
                        value="{{ $contact->subDepartamento }}" autocomplete="subDepartamento" autofocus>
                ...
                <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                    ...
                    <input id="puesto" placeholder="Puesto de trabajo" type="text" title="Puesto de trabajo"
                        ...
                        value="{{ $contact->puesto }}" required autocomplete="puesto" autofocus>
                ...
                <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                    ...
                    <input id="numeroDirecto" type="text" placeholder="Número directo" title="Número directo"
                        ...
                        value="{{ $contact->numeroDirecto }}" autocomplete="numeroDirecto">
                ...
                <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                    ...
                    <input id="extension" type="text" placeholder="Extension del numero directo" title="Extension del numero directo"
                        class="text-primary form-control @error('extension') is-invalid @enderror" name="extension"
                        value="{{ $contact->extension }}" autocomplete="extension">
                ...
                <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                    ...
                    <input id="celular" type="text" placeholder="Celular del contacto" title="Celular del contacto"
                        ...
                        value="{{ $contact->celular }}" autocomplete="celular">
                ...
                <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                    ...
                    <input id="asistente" placeholder="Nombres de asistente" type="text" title="Nombres de asistente"
                        ...
                        value="{{ $contact->asistente }}" autocomplete="asistente" autofocus>
                ...
                <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                    ...
                    <input id="extensionAsistente" type="text" placeholder="Extension de asistente" title="Extension de asistente"
                        class="text-primary form-control @error('extensionAsistente') is-invalid @enderror" name="extensionAsistente"
                        value="{{ $contact->extensionAsistente }}" autocomplete="extensionAsistente">
                ...
                <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                    ...
                    <input id="empresa" placeholder="Empresa" type="text" title="Empresa"
                        ...
                        value="{{ $contact->empresa }}" required autocomplete="empresa" autofocus>
                ...
                <div class="col-12 input-group input-group-lg mb-3">
                    ...
                    <input id="mailGeneral" placeholder="Correo general" type="text" title="Correo general"
                        ...
                        value="{{ $contact->mailGeneral }}" autocomplete="mailGeneral" autofocus>
                ...
                <div class="col-12 input-group input-group-lg mb-3">
                    ...
                    <textarea placeholder="Comentarios del contacto" id="comentarios" title="Comentarios del contacto"
                        ...
                        name="comentarios"
                        required autofocus>{{ $contact->comentarios }}</textarea>
                    @error('comentarios')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
