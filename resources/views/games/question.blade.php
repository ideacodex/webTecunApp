        ...
        <div class="container-fluid">
            <div class="bg-theme-1 d-lg-none d-sm-inline"
                ...
                <div class="bg-theme-1 row justify-content-around d-lg-none d-sm-inline">
                    <img src="{{ asset('img/app/b-trivia.png') }}" class="d-lg-none d-sm-inline img-fluid"
                ...
                @foreach ($questionRandom as $item)
                    <div class="no-gutters">
                        <div class="col-12 col-md-6 offset-md-3 pl-0 pr-0 mt-4">
                            <div class="card bg-theme-2 justify-content-center" style="border-radius: 8px">
                                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('storeUser') }}">
                        ...
                        <div class="col-12 col-md-6 offset-md-3 pl-0 pr-0 mt-4" role="group" aria-label="Basic example">
                            ...
                            <img class="ml-auto" width="20px" height="20px" src="{{ asset('img/app/gamIcon21.png') }}"
                                alt="">
                            <input type="button"
                                onclick="return sendRequestShowAlert('{{ $ansRand1->id }}','{{ $ansRand1->flag }}','{{ $ansRand1->reply }}');"
                                class="triviaquestion btn btn-lg btn-block border-0 justify-content-center d0-flex mb-3"
                    ...
                    <form method="POST" action="{{ url('storeUser') }}">
                        ...
                        <div class="col-12 col-md-6 offset-md-3 pl-0 pr-0 mt-4" role="group" aria-label="Basic example">
                            ...
                            <img class="ml-auto" width="20px" height="20px" src="{{ asset('img/app/gamIcon22.png') }}"
                                alt="">
                            <input type="button"
                    ...
                    @if (isset($ansOthers[0]))
                        <form method="POST" action="{{ url('storeUser') }}">
                            ...
                            <div class="col-12 col-md-6 offset-md-3 pl-0 pr-0 mt-4" role="group" aria-label="Basic example">
                                ...
                                <img class="ml-auto" width="20px" height="20px"
                                    src="{{ asset('img/app/gamIcon23.png') }}" alt="">
                                <input type="button"
                    ...
                    @if (isset($ansOthers[2]))
                        <form method="POST" action="{{ url('storeUser') }}">
                            ...
                            <div class="col-12 col-md-6 offset-md-3 pl-0 pr-0 mt-4" role="group" aria-label="Basic example">
                                ...
                                <img class="ml-auto" width="20px" height="20px"
                                    src="{{ asset('img/app/gamIcon24.png') }}" alt="">
