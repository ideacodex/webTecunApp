                            ...
                            <center>
                                <table cellpadding="0" cellspacing="0" width="600" class="w320">
                                    <tr>
                                        ...
                                        <h2>Han aplicado a la plaza de {{ $request->title }}</h2><br>
                                            {{ $request->name }} {{ $request->lastname }}se postulo a la plaza.<br>
                                            Informacion del solicitante:<br>
                                            Celular: {{ $request->phone }}<br>
                                            Email: {{ $request->email }}<br>
                                            Mensaje: {{ $request->comment }}<br>
                                            <br>
                                        </td>
                                    </tr>
                                </table>
