                                ...
                                <table cellpadding="0" cellspacing="0" width="600" class="w320">
                                    <tr>
                                        <td align="center" class="mobile-padding" style="padding:20px">
                                            ...
                                            <h2>Solicitud enviada</h2><br>
                                            <p>Tu solicitud se envio correctamente con tus datos</p>
                                            <p>Al momento de revisar toda la informacion se comunicaran contigo</p>
                                            <p>por medio de correo electronico o whatsapp</p>
                                            <br>
                                        </td>
                                    </tr>
                                </table>
