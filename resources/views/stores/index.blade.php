...
<div class="container-fluid">
    ...
    <div class="d-flex bd-highlight mb-3">
        ...
        <div class="p-2 bd-highlight">
            <a href=" {{url('storesAdmin/create')}}" class="btn btn-success btn-sm" style="border-radius: 95px">
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group" role="group" aria-label="Basic example">
                            ...
                            <a class="btn btn-sm btn-primary" href="{{url('storesAdmin/'. $item->id . '/edit')}}"
                                title="Editar">
                            ...
                            <form id="formDel{{$item->id}}" action="{{ url('storesAdmin/'. $item->id) }}" method="POST"
                                style="display: none;">
                                @csrf
                                @method('DELETE')
                            </form>
