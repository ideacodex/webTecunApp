...
<div class="container-fluid">
    <div class="row justify-content-center mt-2">
        <p class="text-primary h2">Editar Agencia <i class="fas fa-building"> </i></p>
    </div>
    <div class="mt-4">
            ...
            <div class="form-row">
                ...
                <div class="col-12 input-group input-group-lg mb-3">
                    ...
                    <input id="address" placeholder="Dirección" type="text"
                        ...
                        value="{{ $store->address }}" required autocomplete="address" autofocus>
                ...
                <div class="col-12 input-group input-group-lg mb-3">
                    ...
                    <input id="schedule" name="schedule" placeholder="Horario" type="text"
                        ...
                        value="{{ $store->schedule }}" required autocomplete="schedule" autofocus>
                ...
                <div class="col-12 input-group input-group-lg mb-3">
                    ...
                    <input id="maps" name="maps" placeholder="Link o enlace de waze" type="text"
                        ...
                        value="{{ $store->maps }}" required autocomplete="maps" autofocus>
