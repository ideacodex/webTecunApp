...
<div class="container-fluid">
    ...
    <div class="d-flex bd-highlight mb-3">
        ...
        <div class="p-2 bd-highlight">
            <a href=" {{url('adminPicture/create')}}" class="btn btn-success btn-sm" style="border-radius: 95px">
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group offset-md-3 offset-lg-3" role="group" aria-label="Basic example">
                            <a class="btn btn-sm btn-secondary" href="{{url('adminPicture/'.$item->id)}}"
                                title="Ver Detalles">
                                <span class=""><i class="fas fa-eye"></i></span>
                            </a>
                            <a class="btn btn-sm btn-primary" href="{{url('adminPicture/'.$item->id.'/edit')}}"
                                title="Editar">
                            ...
                            <form id="formDel{{$item->id}}" action="{{ url('adminPicture/'.$item->id) }}" method="POST"
                                style="display: none;">
                                @csrf
                                @method('DELETE')
                            </form>
